...
export default function NosotrosSection() {
  ...
  return (
    <section id="nosotros" className="py-20 bg-slate-cold border-b border-slate-200 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          {/* Mission Card */}
          <div className="bg-primary text-white border border-primary-light rounded-3xl p-8 sm:p-10 shadow-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl from-primary-light/10 to-transparent rounded-bl-full -z-10 group-hover:scale-110 transition-transform duration-300" />
            <div className="flex items-center space-x-4 mb-6">
              <div className="p-3.5 bg-primary-light/45 rounded-2xl border border-primary-light/60 text-accent">
          ...
          {/* Vision Card */}
          <div className="bg-white border border-slate-200 rounded-3xl p-8 sm:p-10 shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden group">
            ...
            <div className="flex items-center space-x-4 mb-6">
              <div className="p-3.5 bg-slate-cold rounded-2xl border border-slate-200 text-primary">
        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-wrap justify-center gap-3.5 max-w-4xl mx-auto">
            {values.map((val, index) => {
              ...
              // Alternate values icons colors
              const iconColor = index % 2 === 0 ? "text-accent" : "text-primary";
              
              return (
                <div
                  key={index}
                  className="bg-white hover:bg-slate-cold border border-slate-205 hover:border-accent px-5 py-3 rounded-full flex items-center space-x-2.5 shadow-sm hover:shadow-md transition-all duration-300 cursor-default group"
                >
                  <IconComp className={`h-4 w-4 shrink-0 transition-all duration-200 group-hover:scale-110 ${iconColor}`} />
