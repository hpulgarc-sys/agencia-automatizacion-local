        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 sm:space-y-8">
            ...
            <div className="space-y-4">
              <span className="bg-slate-cold border border-slate-200 text-primary text-[10px] font-black uppercase tracking-wider px-2.5 py-1 rounded shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {specs.map((spec, index) => {
                const checkColor = index % 2 === 0 ? "text-accent" : "text-primary";
                return (
                  <div key={index} className="flex space-x-3">
                    <div className="bg-slate-cold border border-slate-200 p-2.5 rounded-xl h-10 w-10 shrink-0 flex items-center justify-center shadow-sm">
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative w-full max-w-[380px] sm:max-w-[420px] aspect-[1.4] bg-slate-950 rounded-[28px] p-6.5 shadow-2xl border-4 border-primary flex items-center justify-center silver-glow">
              ...
              <div className="w-full h-full bg-slate-50 rounded-xl overflow-hidden flex flex-col justify-between border border-slate-800 relative">
                ...
                {/* Screen Header */}
                <div className="bg-primary text-white py-2 px-4 flex justify-between items-center text-[10px] font-bold">
                  <div className="flex items-center space-x-1.5">
                    <Tablet className="h-3.5 w-3.5 text-slate-300" />
                    <span>Modo Kiosco Activo</span>
                  </div>
                  <span className="text-accent font-extrabold flex items-center space-x-1">
                ...
                <div className="p-4 flex-grow flex flex-col justify-center space-y-3 bg-white">
                  ...
                  {/* Mock Dashboard */}
                  <div className="border border-slate-250 rounded-xl p-3 bg-slate-cold flex items-center justify-between">
                    ...
                    <span className="bg-primary text-white hover:text-accent text-[9px] font-black px-2 py-1 rounded-lg cursor-pointer transition-colors">
                      Iniciar
                    </span>
                  </div>
 
                  <div className="border border-slate-150 rounded-xl p-3 bg-slate-cold flex items-center justify-between opacity-50 select-none">
                    <div className="space-y-1">
                ...
                {/* Screen Footer */}
                <div className="bg-slate-cold border-t border-slate-200 py-2.5 px-4 text-center text-[9px] text-primary font-bold">
